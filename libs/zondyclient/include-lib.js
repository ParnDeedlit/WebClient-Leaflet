(function () {
  ...
  function load() {
    ...
    if (inArray(includes, 'jquery')) {
      inputScript("http://" + ip + ":" + socket + "/cdn/jquery/jquery.min.js");
    }
    if (inArray(includes, 'geojson')) {
      inputScript("http://" + ip + ":" + socket + "/cdn/geojson/geojson.js");
    }
    if (inArray(includes, 'proj4')) {
      inputScript("http://" + ip + ":" + socket + "/cdn/proj4/proj4.js");
    }
    if (inArray(includes, 'shapefile')) {
      inputScript("http://" + ip + ":" + socket + "/cdn/shapefile/shapefile.js");
    }
    if (inArray(includes, 'checkjs')) {
      inputScript("http://" + ip + ":" + socket + "/cdn/checkjs/checkjs.js");
    }
  }
